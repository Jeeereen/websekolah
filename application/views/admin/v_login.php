...
<body class="bg-primary">
  ...
  <div class="container">
    <div class="card o-hidden border-0 card-login mx-auto mt-5">
      ...
      <div class="card-body">
        <form>
          ...
          <div class="form-group">
            <div class="form-label-group">
              <input type="password" id="passwoard" class="form-control" placeholder="Password" required="required" name="password">
  ...
  <script src="<?= base_url();?>assetsvendor/jquery/jquery.min.js"></script>
